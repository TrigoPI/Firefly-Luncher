...
export default class Exception extends Error {
    ...
    public static async TryFunction(cb: (...args: any) => any, ...args: ArgumentTypes<typeof cb>): Promise<[ReturnType<typeof cb>, Exception]> {
        try {
            const result: ReturnType<typeof cb> = await cb(...args);
